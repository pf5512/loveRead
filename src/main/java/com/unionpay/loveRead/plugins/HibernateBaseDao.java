package com.unionpay.loveRead.plugins;

import com.unionpay.loveRead.utils.ReflectionUtils;
...
public abstract class HibernateBaseDao<T, PK extends Serializable> {
     ...
     */
    public Query createSQLQuery(final String sqlString, final Object... values) {
